...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const resultAction = await dispatch(
        registerUser({ ...formData, age: Number(formData.age) })
      );
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* <Header /> */}
      <HeaderLogin />
      <div className="w-full max-w-5xl mx-auto p-6 my-8 bg-[#EDEDED]">
        ...
        <form
          ...
          className="space-y-4 w-full mx-auto p-8 rounded-lg"
        >
          <div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#0044C1] text-white py-2 rounded-md hover:bg-blue-700 disabled:opacity-50 mt-6"
          >
        ...
        <span className="ml-2 block text-sm text-[#292929] text-center">
