            ...
            <div className="relative z-20 flex justify-start items-center">
              ...
              {isDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 bg-white rounded-lg shadow-lg py-2 w-48 z-50">
                  <NavLink to="/" className="block px-4 py-2 hover:bg-gray-50">
      ...
      <nav className="bg-blue-700 text-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <NavLink to="/upcoming-bookings" className="hover:underline md:mx-8 uppercase">
              Upcoming Bookings
            </NavLink>
            |
            <NavLink to="/todays-bookings" className="hover:underline md:mx-8 uppercase">
              Today's Bookings
            </NavLink>
            |
            <NavLink to="/calendar" className="hover:underline md:mx-8 uppercase">
              Calendar
            </NavLink>
            |
            <NavLink to="/dashboard" className="hover:underline md:mx-8 uppercase">
              Listings
            </NavLink>
          </div>
        </div>
