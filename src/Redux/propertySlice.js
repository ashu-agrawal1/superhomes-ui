...
export const createProperty = createAsyncThunk("property/createProperty", async (propertyData, { rejectWithValue }) => {
  try {
...
export const updateProperty = createAsyncThunk("property/updateProperty", async (propertyData, { rejectWithValue }) => {
  try {
    const formData = new FormData()
    formData.append("title", propertyData.title)
    formData.append("description", propertyData.description)
...
export const fetchFilteredProperties = createAsyncThunk(
  ...
  async (
    { destination, checkin, checkout, price_min, price_max, bedrooms, bathrooms, amenities, is_premium, max_guests },
    { rejectWithValue },
  ) => {
    try {
